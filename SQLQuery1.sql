USE [master]
GO
/****** Object:  Database [Bookstore1]    Script Date: 5/22/2020 9:29:33 AM ******/
CREATE DATABASE [Bookstore1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BookStores', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\pubs.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BookStores_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\pubs_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [Bookstore1] SET COMPATIBILITY_LEVEL = 140
GO
...
GO
ALTER DATABASE [Bookstore1] SET AUTO_CLOSE ON 
GO
...
GO
ALTER DATABASE [Bookstore1] SET RECOVERY SIMPLE 
GO
...
GO
ALTER DATABASE [Bookstore1] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Bookstore1] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Bookstore1] SET QUERY_STORE = OFF
GO
USE [Bookstore1]
GO
/****** Object:  User [admin]    Script Date: 5/22/2020 9:29:33 AM ******/
